...
- A supporting sheet other phases reference but nothing else creates — typically a Lists sheet backing dropdowns (Source, Payment Status, Bank Account) — is its OWN phase, and every phase whose dropdowns or formulas point at it depends on it. Never leave a sheet that is only ever referenced (e.g. Lists!$B$3:$B$20) without a phase that creates it.
